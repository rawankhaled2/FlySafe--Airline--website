...
<body>
    ...
    <div class="ResBox" id="Res">
        ...
        $query01 = mysqli_query($con, "SELECT `TicketNo` FROM res_tic  WHERE Reservation_num ='" . $ResNum . "'")
            or die(mysqli_connect_error());


        if ($query01->num_rows > 0) {
            echo '<h2 class="bold"> Reservation number = ' . $ResNum . '</h2>';
    ...
    traveler.LastName, flight.FlightNo, flight.FromCity, flight.ToCity, flight.DepartureTime,
